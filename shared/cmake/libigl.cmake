...
if(LIBIGL_WITH_EMSCRIPTEN)
  target_compile_definitions(igl_common INTERFACE -DLIBIGL_WITH_EMSCRIPTEN)
endif()
...
if(LIBIGL_WITH_OPENGL)
  ...
  target_link_libraries(igl_opengl ${IGL_SCOPE} opengl)
  target_link_libraries(igl_opengl2 ${IGL_SCOPE} opengl)
  ...
  if(LIBIGL_WITH_VIEWER)
    ...
    target_link_libraries(igl_viewer ${IGL_SCOPE} igl_core glfw glew opengl)
    if(TARGET nanogui)
